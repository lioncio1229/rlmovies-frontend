...
export default function DotsButton({size = 25, onClick} : Props) : JSX.Element {
    return (
        <Button onClick={onClick} width={`${size}px`} height="10" viewBox="0 0 34 10" fill="none" xmlns="http://www.w3.org/2000/svg">
